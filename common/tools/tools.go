...
// 应答方法
func BuildResponse(c *gin.Context, code int, msg string, data interface{}) {
...
func ExtractKillerName(killerKey string) (string) {
	return strings.TrimPrefix(killerKey, constants.JOB_KILLER_DIR)
}
...
func BuildJobSchedulePlan(job *Job) (jobSchedulePlan *JobSchedulePlan, err error) {
	...
	if expr, err = cronexpr.Parse(job.CronExpr); err != nil {
		log.Error("解析job的cron表达式失败 ", job, err)
		return
	}
...
func ExtractWorkerIP(regKey string) (string) {
	return strings.TrimPrefix(regKey, constants.JOB_WORKER_DIR)
}
